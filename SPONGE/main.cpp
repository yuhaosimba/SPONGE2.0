...
void Main_Calculate_Force()
{
    ...
    if (CONTROLLER::MPI_rank < CONTROLLER::PP_MPI_size)
    {
        ...
        PM_Direct_Parameters pm_direct = pm.Get_PM_Direct_Parameters();
        pm.Validate_Direct_Force_Path(
        ...
        {
            lj.LJ_PM_Direct_Force_With_Atom_Energy_And_Virial(
                md_info.atom_numbers, dd.atom_numbers,
                solvent_lj.local_solvent_numbers, dd.ghost_numbers, dd.crd,
                dd.d_charge, dd.frc, md_info.pbc.cell, md_info.pbc.rcell,
                neighbor_list.d_nl, pm.beta, pm_direct, md_info.need_potential,
                dd.d_energy, md_info.need_pressure, dd.d_virial,
                pm.d_direct_atom_energy);

            lj_soft.LJ_Soft_Core_PM_Direct_Force_With_Atom_Energy_And_Virial(
                md_info.atom_numbers, dd.atom_numbers,
                solvent_lj.local_solvent_numbers, dd.ghost_numbers, dd.crd,
                dd.d_charge, dd.frc, md_info.pbc.cell, md_info.pbc.rcell,
        ...
        solvent_lj.LJ_PM_Direct_Force_With_Atom_Energy_And_Virial(
            ...
            pm.beta, md_info.need_potential, pm_direct, dd.d_energy,
        ...
        vatom.Force_Redistribute(dd.crd, md_info.pbc.cell, md_info.pbc.rcell,
                                 dd.frc);
        pm.Sanitize_Force(dd.frc, dd.atom_numbers);
    }
    else
    {
        if (!use_reaxff_eeq)
